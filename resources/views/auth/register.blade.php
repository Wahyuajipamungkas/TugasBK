<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Nama -->
        <div>
            <x-input-label class="text-white" for="nama" :value="__('Nama Lengkap')" />
        ...
        <!-- Alamat -->
        <div class="mt-4">
            <x-input-label class="text-white" for="alamat" :value="__('Alamat')" />
        ...
        <!-- No KTP -->
        <div class="mt-4">
            <x-input-label class="text-white" for="no_ktp" :value="__('Nomor Induk Kependudukan')" />
        ...
        <!-- No Hp -->
        <div class="mt-4">
            <x-input-label class="text-white" for="no_hp" :value="__('Nomor Telepon')" />
