            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <section>
                    ...
                    <div class="mb-4 border-2 card">
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                @if (optional($janjiPeriksa->periksa)->detailPeriksa && optional($janjiPeriksa->periksa)->detailPeriksa->count() > 0)
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @foreach ($janjiPeriksa->periksa->detailPeriksa as $detailPeriksa)
                                            <li class="px-0 list-group-item d-flex justify-content-between align-items-center border-bottom">
                                                <span>{{ $detailPeriksa->obat->nama_obat ?? 'Nama Obat Tidak Ditemukan' }}</span>
